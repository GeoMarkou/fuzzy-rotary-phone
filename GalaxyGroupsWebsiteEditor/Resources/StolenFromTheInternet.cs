...
namespace GalaxyGroupsWebsiteEditor
{
    ...
    {
        //adapted from http://code.msdn.microsoft.com/windowsdesktop/Converting-between-RTF-and-aaa02a6e
        public static string convertRTFToHTML(string rtf)
        {
            string FlowDocumentFormat = "<FlowDocument>{0}</FlowDocument>";

            var xamlText = string.Format(FlowDocumentFormat, ConvertRtfToXaml(rtf));
